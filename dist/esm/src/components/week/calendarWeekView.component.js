...
var CalendarWeekViewComponent = (function () {
    ...
    CalendarWeekViewComponent.prototype.resizeEnded = function (weekEvent) {
        ...
        this.eventTimesChanged.emit({ newStart: newStart, newEnd: newEnd, event: weekEvent.event, droppedOutsideCalendar: false });
    ...
    CalendarWeekViewComponent.prototype.eventDragged = function (weekEvent, draggedByPx, dayWidth) {
        ...
        var droppedOutsideCalendar = false;
        ...
        this.eventTimesChanged.emit({ newStart: newStart, newEnd: newEnd, event: weekEvent.event, droppedOutsideCalendar: droppedOutsideCalendar });
    };
    /**
     * @hidden
     */
